...
const mockOrders: Order[] = [
  {
    id: '1', orderNumber: 'SM-2026-ABC12', buyerName: 'Siti Aminah',
    items: [{ name: 'Mangga Gedong Gincu', qty: 2, price: 70000 }],
    address: 'Jl. Merdeka No. 10, Bandung', total: 85000, status: 'new', date: '12 Jun 2026',
  },
  {
    id: '2', orderNumber: 'SM-2026-DEF34', buyerName: 'Andi Pratama',
    items: [{ name: 'Mangga Harum Manis', qty: 3, price: 126000 }],
    address: 'Jl. Asia Afrika No. 5, Jakarta', total: 141000, status: 'new', date: '12 Jun 2026',
  },
  {
    id: '3', orderNumber: 'SM-2026-GHI56', buyerName: 'Rina Wati',
    items: [{ name: 'Mangga Gedong Gincu', qty: 1, price: 35000 }],
    address: 'Jl. Gatot Subroto No. 20, Cirebon', total: 50000, status: 'processing', date: '11 Jun 2026',
  },
]
              ...
              <div className="space-y-1 mb-3">
                {order.items.map((item, i) => (
                  <div key={i} className="flex justify-between text-sm">
                    <span className="text-leaf-700/70">{item.name} × {item.qty}</span>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {order.status === 'processing' && (
                    <a href={`/petani/pengiriman/${order.id}`}>
